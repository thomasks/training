...
public class ServiceStateModel {
	...
	/**
	 * Map of all valid state transitions [current] [proposed1, proposed2, ...]
	 */
	private static final boolean[][] statemap = {
			// uninited inited started stopped
			/* uninited */ { false, true, false, true }, /* inited */ { false, true, true, true },
			/* started */ { false, false, true, true }, /* stopped */ { false, false, false, true }, };
	 ...
	 * that is considered a non-transition.
	 *
